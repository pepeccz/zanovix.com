...
export default function CursorFollower() {
  ...
  return (
    <div
      ref={followerRef}
      className={cn(
        'fixed top-0 left-0 z-[9999] rounded-full pointer-events-none transition-transform duration-300 ease-out',
        'w-8 h-8 -translate-x-1/2 -translate-y-1/2', // Centering offset
        'bg-primary/20 backdrop-blur-[2px]', // Translucent primary color with blur
